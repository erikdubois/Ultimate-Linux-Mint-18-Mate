...
wget http://downloads.sourceforge.net/project/sardi/sardi-icons-5.5-5.tar.gz -P /tmp/sardi
cd /tmp/sardi
tar -zxvf /tmp/sardi/sardi-icons-5.5-5.tar.gz
rm /tmp/sardi/sardi-icons-5.5-5.tar.gz
mkdir ~/.icons/
